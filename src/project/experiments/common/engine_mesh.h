...
#define MESH_OPTION_INV_GOURAUD			(1 << 6)
#define MESH_OPTION_FAST_MAPCEL			(1 << 7)
#define MESH_OPTION_CPU_POLYTEST		(1 << 8)
#define MESH_OPTION_NO_POLYCLIP			(1 << 9)
#define MESH_OPTION_NO_POLYSORT			(1 << 10)
#define MESH_OPTION_NO_TRANSLATE		(1 << 11)
