...
#endif
{
	...
	if (effectIndex == EFFECT_MESH_SOFT || effectIndex == EFFECT_MESH_GOURAUD_CEL || effectIndex == EFFECT_MESH_WORLD) extraOpts |= CORE_INIT_3D_ENGINE_SOFT;
	if (effectIndex == EFFECT_MESH_GOURAUD_CEL) extraOpts |= CORE_INIT_SEMISOFT_GOURAUD;
